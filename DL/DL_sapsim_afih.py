...
# Constants
BASE_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_AFIH_1_SRV/FactsOfZCDCAFIH?sap-client=300'
DELTA_DISCOVERY_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_AFIH_1_SRV/DeltaLinksOfFactsOfZCDCAFIH?sap-client=300'
NEXT_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_AFIH_1_SRV/'
HEADERS = {
...
DELTA_LINK_PATH = '/tmp/sapsim_afih_delta_link.txt'
SKIP_TOKEN_PATH = '/tmp/sapsim_afih_skip_token.txt'
XML_DIR = '/tmp/sapsim_afih'
DAG_ID = "DL_sapsim_afih"
DAG_INTERVAL = "*/5 * * * *"
...
def load_to_clickhouse(**kwargs):
    ...
    try:
        ...
        for r in records:
            if r['ODQ_CHANGEMODE'] == 'D':
                aufnr = r['AUFNR']
                DELETE_QUERY =  f"ALTER TABLE `sapsim`.`afih` DELETE  WHERE AUFNR = '{aufnr}'"
                client.execute(DELETE_QUERY)
            else:
                client.execute(INSERT_QUERY, r)
        log_status(process_name, random_value, "success")
