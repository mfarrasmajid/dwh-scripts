...
# Constants
BASE_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_AUFK_1_SRV/FactsOfZCDCAUFK?sap-client=300'
DELTA_DISCOVERY_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_AUFK_1_SRV/DeltaLinksOfFactsOfZCDCAUFK?sap-client=300'
NEXT_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_AUFK_1_SRV/'
HEADERS = {
...
DELTA_LINK_PATH = '/tmp/sapsim_aufk_delta_link.txt'
SKIP_TOKEN_PATH = '/tmp/sapsim_aufk_skip_token.txt'
XML_DIR = '/tmp/sapsim_aufk'
DAG_ID = "DL_sapsim_aufk"
DAG_INTERVAL = "3-59/15 * * * *"
...
INSERT_QUERY = """
                    ...
                    `LTEXT`,`BUKRS`,`WERKS`,`GSBER`,`KOKRS`,`CCKEY`,`KOSTV`,`STORT`,`SOWRK`,  
                    `ASTKZ`,`WAERS`,`ASTNR`,`STDAT`,`ESTNR`,`PHAS0`,`PHAS1`,`PHAS2`,`PHAS3`,     
                    `PDAT1`,`PDAT2`,`PDAT3`,`IDAT1`,`IDAT2`,`IDAT3`,`OBJID`,`VOGRP`,`LOEKZ`,     
                    `PLGKZ`,`KVEWE`,`KAPPL`,`KALSM`,`ZSCHL`,`ABKRS`,`KSTAR`,`KOSTL`,`SAKNR`,     
                    `SETNM`,`CYCLE`,`SDATE`,`SEQNR`,`USER0`,`USER1`,`USER2`,`USER3`,`USER4`, 
                    `USER5`,`USER6`,`USER7`,`USER8`,`USER9`,`OBJNR`,`PRCTR`,`PSPEL`,`AWSLS`,     
                    `ABGSL`,`EBPOST`,`TXJCD`,`FUNCAREA`,`SCOPE`,`PLINT`,`KDAUF`,`KDPOS`,     
                    `AUFEX`,`IVPRO`,`LOGSYSTEM`,`FLGMLTPS`,`ABUKR`,`AKSTL`,`SIZECL`,       
                    `IZWEK`,`UMWKZ`,`KSTEMPF`,`ZSCHM`,`PKOSA`,`ANFAUFNR`,`PROCNR`,`PROTY`,     
                    `RSORD`,`BEMOT`,`ADRNRA`,`ERFZEIT`,`AEZEIT`,`CSTGVRNT`,`COSTESTNR`, 
                    `VERAAUSER`,`EEWAUFKPSDUMMY`,`VNAME`,`RECID`,`ETYPE`,`OTYPE`,`JVJIBCL`, 
                    `JVJIBSA`,`JVOCO`,`CPDUPDAT`,`INDCU`,`CMNUM`,`AUEST`,`DESNUM`,`AD01PROFNR`, 
                    `VAPLZ`,`WAWRK`,`FERCIND`,`AUFKSTATUS`,`CLAIMCONTROL`,`UPDATENEEDED`, 
                    `UPDATECONTROL`,`ODQ_CHANGEMODE`,`ODQ_ENTITYCNTR`)
                    VALUES
                    (%(AUFNR)s, %(AUART)s, %(AUTYP)s, %(REFNR)s, %(ERNAM)s, %(ERDAT)s, %(AENAM)s,     
                    %(AEDAT)s, %(KTEXT)s, %(LTEXT)s, %(BUKRS)s, %(WERKS)s, %(GSBER)s, %(KOKRS)s,  
                    %(CCKEY)s, %(KOSTV)s, %(STORT)s, %(SOWRK)s, %(ASTKZ)s, %(WAERS)s, %(ASTNR)s,  
                    %(STDAT)s, %(ESTNR)s, %(PHAS0)s, %(PHAS1)s, %(PHAS2)s, %(PHAS3)s, %(PDAT1)s,  
                    %(PDAT2)s, %(PDAT3)s, %(IDAT1)s, %(IDAT2)s, %(IDAT3)s, %(OBJID)s, %(VOGRP)s,     
                    %(LOEKZ)s, %(PLGKZ)s, %(KVEWE)s, %(KAPPL)s, %(KALSM)s, %(ZSCHL)s, %(ABKRS)s, 
                    %(KSTAR)s, %(KOSTL)s, %(SAKNR)s, %(SETNM)s, %(CYCLE)s, %(SDATE)s, %(SEQNR)s,
                    %(USER0)s, %(USER1)s, %(USER2)s, %(USER3)s, %(USER4)s, %(USER5)s, %(USER6)s,     
                    %(USER7)s, %(USER8)s, %(USER9)s, %(OBJNR)s, %(PRCTR)s, %(PSPEL)s, %(AWSLS)s,     
                    %(ABGSL)s, %(EBPOST)s, %(TXJCD)s, %(FUNCAREA)s, %(SCOPE)s, %(PLINT)s, %(KDAUF)s,     
                    %(KDPOS)s, %(AUFEX)s, %(IVPRO)s, %(LOGSYSTEM)s, %(FLGMLTPS)s, %(ABUKR)s, %(AKSTL)s,     
                    %(SIZECL)s, %(IZWEK)s, %(UMWKZ)s, %(KSTEMPF)s, %(ZSCHM)s, %(PKOSA)s, %(ANFAUFNR)s,     
                    %(PROCNR)s, %(PROTY)s, %(RSORD)s, %(BEMOT)s, %(ADRNRA)s, %(ERFZEIT)s, %(AEZEIT)s, 
                    %(CSTGVRNT)s, %(COSTESTNR)s, %(VERAAUSER)s, %(EEWAUFKPSDUMMY)s, %(VNAME)s, 
                    %(RECID)s, %(ETYPE)s, %(OTYPE)s, %(JVJIBCL)s, %(JVJIBSA)s, %(JVOCO)s, %(CPDUPDAT)s, 
                    %(INDCU)s, %(CMNUM)s, %(AUEST)s, %(DESNUM)s, %(AD01PROFNR)s, %(VAPLZ)s, %(WAWRK)s,  
                    %(FERCIND)s, %(AUFKSTATUS)s, %(CLAIMCONTROL)s, %(UPDATENEEDED)s, %(UPDATECONTROL)s, 
    ...
    try:
        ...
        if next_link_el is not None:
            ...
            if skiptoken:
                ...
                skiptoken_url = f"FactsOfZCDCAUFK?sap-client=300&$skiptoken={skiptoken}"
...
def load_to_clickhouse(**kwargs):
    ...
    try:
        ...
        for r in records:
            if r['ODQ_CHANGEMODE'] == 'D':
                aufnr = r['AUFNR']
                DELETE_QUERY =  f"ALTER TABLE `sapsim`.`aufk` DELETE  WHERE AUFNR = '{aufnr}'"
                client.execute(DELETE_QUERY)
            else:
                client.execute(INSERT_QUERY, r)
        log_status(process_name, random_value, "success")
