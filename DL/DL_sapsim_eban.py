...
# Constants
BASE_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_EBAN_2_SRV/FactsOfZCDCEBAN?sap-client=300'
DELTA_DISCOVERY_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_EBAN_2_SRV/DeltaLinksOfFactsOfZCDCEBAN?sap-client=300'
NEXT_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_EBAN_2_SRV/'
HEADERS = {
...
DELTA_LINK_PATH = '/tmp/sapsim_eban_delta_link.txt'
SKIP_TOKEN_PATH = '/tmp/sapsim_eban_skip_token.txt'
XML_DIR = '/tmp/sapsim_eban'
DAG_ID = "DL_sapsim_eban"
    ...
    try:
        ...
        for r in records:
            if r['ODQ_CHANGEMODE'] == 'D':
                banfn = r['BANFN']
                bnfpo = r['BNFPO']
                DELETE_QUERY =  f"ALTER TABLE `sapsim`.`eban` DELETE WHERE BANFN = '{banfn}' AND BNFPO = '{bnfpo}'"
                client.execute(DELETE_QUERY)
            else:
                client.execute(INSERT_QUERY, r)
        log_status(process_name, random_value, "success")
