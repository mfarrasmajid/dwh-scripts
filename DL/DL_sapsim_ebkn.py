...
# Constants
BASE_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_EBKN_1_SRV/FactsOfZCDCEBKN?sap-client=300'
DELTA_DISCOVERY_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_EBKN_1_SRV/DeltaLinksOfFactsOfZCDCEBKN?sap-client=300'
NEXT_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_EBKN_1_SRV/'
HEADERS = {
...
DELTA_LINK_PATH = '/tmp/sapsim_ebkn_delta_link.txt'
SKIP_TOKEN_PATH = '/tmp/sapsim_ebkn_skip_token.txt'
XML_DIR = '/tmp/sapsim_ebkn'
DAG_ID = "DL_sapsim_ebkn"
    ...
    try:
        ...
        for r in records:
            if r['ODQ_CHANGEMODE'] == 'D':
                ...
                bnfpo = r['BNFPO']
                zebkn = r['ZEBKN']
                DELETE_QUERY =  f"ALTER TABLE `sapsim`.`ebkn` DELETE WHERE BANFN = '{banfn}' AND BNFPO = '{bnfpo}' AND ZEBKN = {zebkn}"
                client.execute(DELETE_QUERY)
            else:
                client.execute(INSERT_QUERY, r)
        log_status(process_name, random_value, "success")
