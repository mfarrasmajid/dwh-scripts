...
# Constants
BASE_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_EKKO_2_SRV/FactsOfZCDCEKKO?sap-client=300'
DELTA_DISCOVERY_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_EKKO_2_SRV/DeltaLinksOfFactsOfZCDCEKKO?sap-client=300'
NEXT_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_EKKO_2_SRV/'
HEADERS = {
...
DELTA_LINK_PATH = '/tmp/sapsim_ekko_delta_link.txt'
SKIP_TOKEN_PATH = '/tmp/sapsim_ekko_skip_token.txt'
XML_DIR = '/tmp/sapsim_ekko'
DAG_ID = "DL_sapsim_ekko"
DAG_INTERVAL = "6-59/15 * * * *"
...
def load_to_clickhouse(**kwargs):
    ...
    try:
        ...
        for r in records:
            if r['ODQ_CHANGEMODE'] == 'D':
                ebeln = r['EBELN']
                DELETE_QUERY =  f"ALTER TABLE `sapsim`.`ekko` DELETE  WHERE EBELN = '{ebeln}'"
                client.execute(DELETE_QUERY)
            else:
                client.execute(INSERT_QUERY, r)
        log_status(process_name, random_value, "success")
