...
# Constants
BASE_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_IFLOT_1_SRV/FactsOfZCDCIFLOT?sap-client=300'
DELTA_DISCOVERY_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_IFLOT_1_SRV/DeltaLinksOfFactsOfZCDCIFLOT?sap-client=300'
NEXT_URL = 'http://dmterpsim.mitratel.co.id:8041/sap/opu/odata/sap/ZCDC_IFLOT_1_SRV/'
HEADERS = {
...
DELTA_LINK_PATH = '/tmp/sapsim_iflot_delta_link.txt'
...
INSERT_QUERY = """
                    INSERT INTO `sapsim`.`iflot`
                    (`TPLNR`, `MLANG`, `TPLKZ`, `FLTYP`, `TPLMA`, `ERDAT`, `ERNAM`, `AEDAT`, 
                    `AENAM`, `DATAB`, `BEGRU`, `TRPNR`, `PSTAE`, `STNAM`, `LVORM`, `SUBMT`, 
                    `SUBMTI`, `MAPAR`, `MAPARI`, `IEQUI`, `IEQUII`, `EINZL`, `EINZLI`, `IWERK`, 
                    `IWERKI`, `INGRP`, `INGRPI`, `PMOBJTY`, `LGWID`, `LGWIDI`, `RBNR`, `RBNRI`, 
                    `ILOAN`, `OBJNR`, `POSNR`, `ISTYP`, `PREMS`, `EQART`, `INVNR`, `GROES`, `BRGEW`, 
                    `GEWEI`, `ANSWT`, `WAERS`, `ANSDT`, `HERST`, `HERLD`, `BAUJJ`, `BAUMM`, `TYPBZ`, 
                    `EMATN`, `SERGE`, `HANDLE`, `TSEGTP`, `CHANGEDDATETIME`, `ZZITORINGNAME`, 
                    `ZZITOWITEL`, `ZZITOGROUPPROJSOURCE`, `ZZITOPHYSICALLENGTH`, `ZZITOBILLABLELENGTH`, 
                    `ZZITOBASTDATE`, `ZZITOOPMDB`, `ZZITOPROJECTSOURCE`, `ZZITONESITEIDMTEL`, 
                    `ZZITONESITEIDTENANT`, `ZZITONESITENAME`, `ZZITONESITETOWEROWNER`, `ZZITONELONGITUDE`, 
                    `ZZITONELATITUDE`, `ZZITOFESITEIDMTEL`, `ZZITOFESITEIDTENANT`, `ZZITOFESITENAME`, 
                    `ZZITOFESITETOWEROWNER`, `ZZITOFELONGITUDE`, `ZZITOFELATITUDE`, `ZZITOSEGPHYSICALLENGTH`, 
                    `ZZITOSEGBILLABLELENGTH`, `ZZITOOWNER`, `ZZITOJALURPID`, `DUMMYIFLOTINCLEEWPS`, 
                    `FLLBDUTY`, `FLLBHIDE`, `IFLOTSRTYPE`, `IFLOTSNTYPE`, `ODQ_CHANGEMODE`, `ODQ_ENTITYCNTR`)
                    VALUES
                    (
                    %(TPLNR)s, %(MLANG)s, %(TPLKZ)s, %(FLTYP)s, %(TPLMA)s, %(ERDAT)s, %(ERNAM)s, %(AEDAT)s, 
                    %(AENAM)s, %(DATAB)s, %(BEGRU)s, %(TRPNR)s, %(PSTAE)s, %(STNAM)s, %(LVORM)s, %(SUBMT)s, 
                    %(SUBMTI)s, %(MAPAR)s, %(MAPARI)s, %(IEQUI)s, %(IEQUII)s, %(EINZL)s, %(EINZLI)s, %(IWERK)s, 
                    %(IWERKI)s, %(INGRP)s, %(INGRPI)s, %(PMOBJTY)s, %(LGWID)s, %(LGWIDI)s, %(RBNR)s, %(RBNRI)s, 
                    %(ILOAN)s, %(OBJNR)s, %(POSNR)s, %(ISTYP)s, %(PREMS)s, %(EQART)s, %(INVNR)s, %(GROES)s, 
                    %(BRGEW)s, %(GEWEI)s, %(ANSWT)s, %(WAERS)s, %(ANSDT)s, %(HERST)s, %(HERLD)s, %(BAUJJ)s, 
                    %(BAUMM)s, %(TYPBZ)s, %(EMATN)s, %(SERGE)s, %(HANDLE)s, %(TSEGTP)s, %(CHANGEDDATETIME)s, 
                    %(ZZITORINGNAME)s, %(ZZITOWITEL)s, %(ZZITOGROUPPROJSOURCE)s, %(ZZITOPHYSICALLENGTH)s, 
                    %(ZZITOBILLABLELENGTH)s, %(ZZITOBASTDATE)s, %(ZZITOOPMDB)s, %(ZZITOPROJECTSOURCE)s, 
                    %(ZZITONESITEIDMTEL)s, %(ZZITONESITEIDTENANT)s, %(ZZITONESITENAME)s, %(ZZITONESITETOWEROWNER)s, 
                    %(ZZITONELONGITUDE)s, %(ZZITONELATITUDE)s, %(ZZITOFESITEIDMTEL)s, %(ZZITOFESITEIDTENANT)s, 
                    %(ZZITOFESITENAME)s, %(ZZITOFESITETOWEROWNER)s, %(ZZITOFELONGITUDE)s, %(ZZITOFELATITUDE)s, 
                    %(ZZITOSEGPHYSICALLENGTH)s, %(ZZITOSEGBILLABLELENGTH)s, %(ZZITOOWNER)s, %(ZZITOJALURPID)s, 
                    %(DUMMYIFLOTINCLEEWPS)s, %(FLLBDUTY)s, %(FLLBHIDE)s, %(IFLOTSRTYPE)s, %(IFLOTSNTYPE)s, 
...
def load_to_clickhouse(**kwargs):
    ...
    try:
        ...
        for r in records:
            if r['ODQ_CHANGEMODE'] == 'D':
                tplnr = r['TPLNR']
                DELETE_QUERY =  f"ALTER TABLE `sapsim`.`iflot` DELETE  WHERE TPLNR = '{tplnr}'"
                client.execute(DELETE_QUERY)
            else:
                client.execute(INSERT_QUERY, r)
        log_status(process_name, random_value, "success")
