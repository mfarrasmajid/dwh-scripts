...
MYSQL_TABLE = "tabGood Receipt"
CLICKHOUSE_DATABASE = "spmk"
CLICKHOUSE_TABLE = "tabgoodreceipt"
FILE_PATH = "/tmp/debug_DL_spmk_tabgoodreceipt.json"
DAG_ID = "DL_spmk_tabgoodreceipt"
DAG_INTERVAL = "4 17 * * *"
CHUNK_SIZE = 5000
