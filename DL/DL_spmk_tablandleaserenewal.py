...
MYSQL_TABLE = "tabLand Lease Renewal"
CLICKHOUSE_DATABASE = "spmk"
CLICKHOUSE_TABLE = "tablandleaserenewal"
FILE_PATH = "/tmp/batch_tablandleaserenewal_"
DAG_ID = "DL_spmk_tablandleaserenewal"
DAG_INTERVAL = "*/5 * * * *"
CHUNK_SIZE = 5000
BATCH_SIZE = 10000
BATCH_NO = 9
...
TAGS = ["dl", "spmk", "tablandleaserenewal"]
