...
MYSQL_TABLE = "tabPurchase Order"
CLICKHOUSE_DATABASE = "spmk"
CLICKHOUSE_TABLE = "tabpurchaseorder"
FILE_PATH = "/tmp/debug_DL_spmk_tabpurchaseorder.json"
DAG_ID = "DL_spmk_tabpurchaseorder"
DAG_INTERVAL = "28 17 * * *"
CHUNK_SIZE = 5000
