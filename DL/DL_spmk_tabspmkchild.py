...
MYSQL_TABLE = "tabSPMK Child"
CLICKHOUSE_DATABASE = "spmk"
CLICKHOUSE_TABLE = "tabspmkchild"
FILE_PATH = "/tmp/debug_DL_spmk_tabspmkchild.json"
DAG_ID = "DL_spmk_tabspmkchild"
DAG_INTERVAL = "10 17 * * *"
CHUNK_SIZE = 5000
