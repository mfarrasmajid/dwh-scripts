...
MYSQL_TABLE = "tabSPMK List Child"
CLICKHOUSE_DATABASE = "spmk"
CLICKHOUSE_TABLE = "tabspmklistchild"
FILE_PATH = "/tmp/debug_DL_spmk_tabspmklistchild.json"
DAG_ID = "DL_spmk_tabspmklistchild"
DAG_INTERVAL = "12 17 * * *"
CHUNK_SIZE = 5000
