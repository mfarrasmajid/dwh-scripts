...
MYSQL_TABLE = "tabTask Progress Child"
CLICKHOUSE_DATABASE = "spmk"
CLICKHOUSE_TABLE = "tabtaskprogresschild"
FILE_PATH = "/tmp/debug_DL_spmk_tabtaskprogresschild.json"
DAG_ID = "DL_spmk_tabtaskprogresschild"
DAG_INTERVAL = "18 17 * * *"
CHUNK_SIZE = 5000
...
TAGS = ["dl", "spmk", "tabtaskprogresschild"]
