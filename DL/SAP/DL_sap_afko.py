...
# Constants
BASE_URL = 'http://dmterpprd2.mitratel.co.id:8031/sap/opu/odata/sap/ZCDC_AFKO_1_SRV/FactsOfZCDCAFKO?sap-client=300'
DELTA_DISCOVERY_URL = 'http://dmterpprd2.mitratel.co.id:8031/sap/opu/odata/sap/ZCDC_AFKO_1_SRV/DeltaLinksOfFactsOfZCDCAFKO?sap-client=300'
NEXT_URL = 'http://dmterpprd2.mitratel.co.id:8031/sap/opu/odata/sap/ZCDC_AFKO_1_SRV/'
HEADERS = {
...
DELTA_LINK_PATH = '/tmp/sap_afko_delta_link.txt'
SKIP_TOKEN_PATH = '/tmp/sap_afko_skip_token.txt'
XML_DIR = '/tmp/sap_afko'
DAG_ID = "DL_sap_afko"
DAG_INTERVAL = "*/3 * * * *"
