...
MYSQL_TABLE = "tabMaintenance Order"
CLICKHOUSE_DATABASE = "om"
CLICKHOUSE_TABLE = "tabmaintenanceorder"
FILE_PATH = "/tmp/batch_tabmaintenanceorder_"
DAG_ID = "DL_om_tabmaintenanceorder"
DAG_INTERVAL = "2-59/5 * * * *"
CHUNK_SIZE = 5000
BATCH_SIZE = 10000
BATCH_NO = 9
...
TAGS = ["dl", "om", "tabmaintenanceorder"]
