...
MYSQL_TABLE = "tabNomor PR BOQ"          # has a space → quoted with backticks
CLICKHOUSE_DATABASE = "spmk"
CLICKHOUSE_TABLE = "tabnomorprboq"
...
TMP_DIR = "/tmp"
NDJSON_PREFIX = "DL_spmk_tabnomorprboq_"
...
# DAG
DAG_ID = "DL_spmk_tabnomorprboq"
DAG_INTERVAL = "*/15 * * * *"
TAGS = ["dl", "spmk", "tabnomorprboq", "incremental"]
