...
MYSQL_TABLE = "tabTask Depends On"
CLICKHOUSE_DATABASE = "spmk"
CLICKHOUSE_TABLE = "tabtaskdependson"
FILE_PATH = "/tmp/debug_DL_spmk_tabtaskdependson.json"
DAG_ID = "DL_spmk_tabtaskdependson"
DAG_INTERVAL = "16 17 * * *"
CHUNK_SIZE = 5000
