...
MYSQL_TABLE = "tabWO Site List Colo"
CLICKHOUSE_DATABASE = "spmk"
CLICKHOUSE_TABLE = "tabwositelistcolo"
FILE_PATH = "/tmp/debug_DL_spmk_tabwositelistcolo.json"
DAG_ID = "DL_spmk_tabwositelistcolo"
DAG_INTERVAL = "26 17 * * *"
CHUNK_SIZE = 5000
...
TAGS = ["dl", "spmk", "tabwositelistcolo"]
