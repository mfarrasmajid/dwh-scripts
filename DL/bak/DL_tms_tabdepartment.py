...
MYSQL_TABLE = "tabDepartment"
CLICKHOUSE_DATABASE = "tms"
CLICKHOUSE_TABLE = "tabdepartment"
FILE_PATH = "/tmp/debug_DL_tms_tabdepartment.json"
DAG_ID = "DL_tms_tabdepartment"
DAG_INTERVAL = "45 18 * * *"
CHUNK_SIZE = 5000
