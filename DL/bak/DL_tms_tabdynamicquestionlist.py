...
MYSQL_TABLE = "tabDynamic Question List"
CLICKHOUSE_DATABASE = "tms"
CLICKHOUSE_TABLE = "tabdynamicquestionlist"
FILE_PATH = "/tmp/debug_DL_tms_tabdynamicquestionlist.json"
DAG_ID = "DL_tms_tabdynamicquestionlist"
DAG_INTERVAL = "2-59/5 * * * *"
CHUNK_SIZE = 5000
...
TAGS = ["dl", "sap", "tabdynamicquestionlist"]
