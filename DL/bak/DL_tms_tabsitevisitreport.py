...
MYSQL_TABLE = "tabSite Visit Report"
CLICKHOUSE_DATABASE = "tms"
CLICKHOUSE_TABLE = "tabsitevisitreport"
FILE_PATH = "/tmp/batch_report_"
DAG_ID = "DL_tms_tabsitevisitreport"
DAG_INTERVAL = "1-59/5 * * * *"
CHUNK_SIZE = 500
BATCH_SIZE = 1500
BATCH_NO = 5
...
TAGS = ["dl", "tms", "tabsitevisitreport"]
