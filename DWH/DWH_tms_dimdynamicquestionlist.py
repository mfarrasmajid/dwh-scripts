...
TARGET_TABLE = "dim_dynamicquestionlist"
FILE_PATH = "/tmp/debug_DWH_tms_dymamicquestionlist.json"
DAG_ID = "DWH_tms_dymamicquestionlist"
DAG_INTERVAL = "3-59/5 * * * *"
CHUNK_SIZE = 5000
...
TAGS = ["dwh", "tms", "dymamicquestionlist"]

EXTRACT_QUERY = """
    SELECT name AS questionid,
        parent,
        question,
        group,
        text_answer,
        ...
        pict_answer,
        now() as updated_at
    FROM tms.tabdynamicquestionlist FINAL
    """

SOURCE_COLUMNS=['questionid', 'parent', 'question', 'group',
                'text_answer', 'number_answer', 'pict_answer',
                'updated_at']
